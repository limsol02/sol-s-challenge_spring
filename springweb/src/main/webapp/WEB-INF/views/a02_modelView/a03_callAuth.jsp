...
<%--
Controller : A02_MVC_CheckAdultCtrl
	//	http://localhost:7080/springweb/checkAdult.do (?age=15)
	요청값이 18이상이면  성년, 그 외에는 미성년.

jsp : a04_checkAdult.jsp

--%>
<div class="container"><%--?name=홍길동--%>
   <form id="frm01" class="form"  method="post">
     <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
     
       <input class="form-control mr-sm-2" placeholder="이름 입력" name="name" />
       <button class="btn btn-info" type="submit" id="ckAuth">권한 확인</button>
   ...
   <table class="table table-hover table-striped">
    ...
    <tbody>
       <tr><td>${param.name}</td><td>${auth}</td></tr>
